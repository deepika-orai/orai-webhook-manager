...
export function WelcomeSplash({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center max-w-xl w-full text-center px-4 my-auto animate-card-enter">
        {/* 1. Official ORAI Logo (Theme-aware, transparent, balanced size) */}
        <div className="mb-2 sm:mb-2.5 flex justify-center items-center">
          <OraiLogo
            imageClassName="w-[165px] sm:w-[190px] md:w-[215px] lg:w-[225px] h-auto"
            priority
          />
        </div>
        ...
        {/* 3. Primary Heading - Strongest Visual Anchor */}
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-purple-950 dark:text-purple-100 tracking-tight leading-tight mb-3 sm:mb-4">
          Welcome to ORAI
        </h1>

        {/* 4. Tenant Personalized Greeting (with safe truncation for long tenant names) */}
        <div className="max-w-[320px] sm:max-w-md px-4 py-2 rounded-2xl bg-white/90 dark:bg-slate-900/90 border border-purple-100 dark:border-slate-800 backdrop-blur-md shadow-xs mb-3 sm:mb-4 flex items-center justify-center gap-2">
          <span className="w-2 h-2 rounded-full bg-emerald-500 shrink-0 animate-pulse-subtle" aria-hidden="true" />
          <span
            className="text-base sm:text-lg font-bold text-purple-900 dark:text-purple-200 truncate"
            title={`Hello, ${safeTenantName}`}
          >
        ...
        {/* 5. Tagline */}
        <p className="text-sm sm:text-base font-medium text-slate-600 dark:text-slate-300 max-w-sm sm:max-w-md leading-relaxed mb-4 sm:mb-5">
